...
Providers are the upstream AI services that Odock can call on your behalf. Examples include OpenAI, Anthropic, Google Gemini, Azure OpenAI, vLLM, Mistral, Hugging Face, and custom-compatible providers.
...
| `HUGGINGFACE` | Hugging Face Inference Providers: OpenAI-compatible chat over hundreds of open models and many upstream providers. See [Hugging Face](/docs/models-and-mcp/providers/huggingface). |
...
- [Hugging Face](/docs/models-and-mcp/providers/huggingface)
