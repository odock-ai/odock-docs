...
| --- | --- | --- |
| [`STREAMABLE_HTTP`](/docs/models-and-mcp/mcp-servers/streamable-http-transport) | The MCP server exposes an HTTP endpoint that supports streamable MCP traffic. | Endpoint URL. |
| [`SSE`](/docs/models-and-mcp/mcp-servers/sse-transport) | The MCP server streams responses using server-sent events. | Endpoint URL. |
| [`STDIO`](/docs/models-and-mcp/mcp-servers/stdio-transport) | Odock should launch a local command and communicate over standard input/output. | Command, args, and optional environment JSON. |
...
For auth config examples, see [MCP authentication](/docs/models-and-mcp/mcp-servers/authentication).
...
For MCP-specific access grants, scopes, tool rules, semantic filters, and transport security, see [MCP security](/docs/models-and-mcp/mcp-servers/security).
...
For pricing fields, cost formula, and examples, see [MCP pricing](/docs/models-and-mcp/mcp-servers/pricing).
...
- [MCP pricing](/docs/models-and-mcp/mcp-servers/pricing)
...
- [Call an MCP server through Odock](/docs/models-and-mcp/mcp-servers/call-through-odock)
