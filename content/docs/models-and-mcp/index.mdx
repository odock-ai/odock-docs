...
| --- | --- | --- |
| Provider | The upstream AI service connection, such as OpenAI, Anthropic, Google, Azure OpenAI, vLLM, or a custom-compatible provider. | Selecting the upstream API family, base URL, timeout, and provider implementation. |
