...
For deeper pages, see [Routing](/docs/management/routing), [Guardrails](/docs/security-and-guardrails/guardrails), [SafetySec Engine](/docs/security-and-guardrails/safetysec-engine), [Plugin Architecture](/docs/plugins/architecture), [Plugin Phases & lifecycle](/docs/plugins/phases-and-lifecycle), and [Usage Monitoring](/docs/observability/usage-monitoring).
...
The provider path supports Odock's unified LLM endpoint and provider-compatible endpoints for OpenAI, Anthropic, Gemini, and vLLM shapes. For calling patterns, see [Unified Multi Model Endpoint Call](/docs/usage/unified-multi-model-endpoint-call) and [Native Models Call](/docs/usage/native-models-call). For MCP behavior, see [MCP Servers](/docs/models-and-mcp/mcp-servers).
